...
def main():
    ...
    text_with_explanation="if you don't know how to download the file is > Go to WhatsApp > to the chat that you want > Settings > More > Export chat (without media) (click to see example)"
    ...
    with st.expander(text_with_explanation):
